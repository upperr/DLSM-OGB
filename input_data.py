...
def load_edge_data(dataset, max_degree):
    ...
    neighbors_train_sample = {}
    neighbors_train_sample['out'], neighbors_train_sample['in'] = sample_neighbors(neighbors, max_degree)
    ...
    for s, t in test_pos_edges:
        ...
        neighbors['in'][t].append(s)
    neighbors_sample = {}
    neighbors_sample['out'], neighbors_sample['in'] = sample_neighbors(neighbors, max_degree)
    ...
    return train_edges, val_edges, test_edges, features, neighbors_train_sample, neighbors_sample
